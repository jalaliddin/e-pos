<tr class="odd:bg-white even:bg-gray-100">
    <td class="px-2 py-1 border-r dark:text-gray-100 min-w-[200px] max-w-[400px] whitespace-normal break-words"">{{ $cartItem->name }}</td>
    <td class="px-2 py-1 border-r text-center dark:text-gray-100">{{ number_format($cartItem->price, 2) }}</td>
